 ...
 */
    ...
    public static void ortalamaBul(String isim, double... notlar) { // we create method manually

        double toplam = 0;
        for (double each: notlar) {
            toplam += each;
        }
        System.out.println(isim+ " kisinin not ortalamsi : "+toplam/notlar.length); // notlar array gibi davrandiindan lenghtini aldik
    }
}

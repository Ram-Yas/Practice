...
public class Q1_ArmstrongNumber {
    ...
    private static void armstrong(int n) {
        ...
        while (n>0){
            basamaktakiSayi = n%10; // birler basamagini almak icin
            sayininKupleriToplami+= (basamaktakiSayi*basamaktakiSayi*basamaktakiSayi);
            n = n/10; //birler basamagini iptal edip sayiyi kucultur
        }
    ...
    private static void girilenSayiyaKadarOlanArmstrong(int sayi) {
        ...
        for (int i = 1; i <=sayi ; i++) {
            ...
            armstrong(i);//recursive method uyguladik. methodun icinde baska bir method

...
public class Q02_2D_CollectionsTask {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<String>> listeler = new ArrayList<>(); // 2D arrayList Çalışanlar, İşverenler, Şirketler
        ...
        // [[Ahmet, Ali, Emrah, Elif, technical support], [Haluk, Eylul, Yusuf, Can, Ibrahim, Mehmet], [Amazon, Google, Testinium, IBM]]

...
public class Q03_CollectionsMethodsTask {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(arrList, Collections.reverseOrder()); // reverseOrder() method'u ters siralar
                                                                // decsending yani azalan siralama yapar
                                                                // sort () siralar

        System.out.println("Ters siraladiktan sonra arrList: "+ arrList);

        Collections.shuffle(arrList); // rastgele karistirir
        System.out.println("shuffle yapiktan sonnra : "+arrList);

        Collections.rotate(arrList,3); // belirtilen listedeki ogeleri kaydirir. distance hangi numara ise ondan baslar
